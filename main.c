...
void init_data(t_game game) {
  ...
  get_data()->floor_color = CREATE_TRGB(
      0, game.floor.r, game.floor.g,
      game.floor
          .b); // BROWN;// TODO this just for startin befroe parsing is complete
  get_data()->ceiling_color = CREATE_TRGB(
      0, game.ceiling.r, game.ceiling.g,
      game.ceiling
          .b); // CYAN;// TODO this just for startin befroe parsing is complete
  // init_background();
  ...
  get_data()->door_open_img.img_data.img = mlx_xpm_file_to_image(
      get_data()->mlx, "textures/door_frames/17.xpm",
      &(get_data()->door_open_img.width), &(get_data()->door_open_img.height));
...
void load_zooming_gun3_frames(void) {
  char *frame_paths[19] = {
      ...
      "textures/zoom_shoot_gun3/7.xpm",  "textures/zoom_shoot_gun3/8.xpm",
      "textures/zoom_shoot_gun3/9.xpm",  "textures/zoom_shoot_gun3/10.xpm",
      "textures/zoom_shoot_gun3/11.xpm", "textures/zoom_shoot_gun3/12.xpm",
      "textures/zoom_shoot_gun3/13.xpm", "textures/zoom_shoot_gun3/14.xpm",
      "textures/zoom_shoot_gun3/15.xpm"};

  printf("here\n");
  int i;
  i = 0;
  while (i < 15) {
    get_data()->gun3.zoom_shooting_frames[i] = safer_xpm_file_to_image(
        get_data()->mlx, frame_paths[i], &get_data()->gun3.width,
        &get_data()->gun3.height);
    i++;
  }

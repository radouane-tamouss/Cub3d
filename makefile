...
RENDER_FILES = rendering/put_pixel.c rendering/background.c rendering/event_handling.c rendering/rotation.c rendering/movement.c rendering/ft_math.c rendering/walls.c rendering/minimap.c rendering/sprites.c rendering/vector.c rendering/ray.c rendering/color.c rendering/render_shapes.c
